...
class AppointmentController(http.Controller):
    ...
    def confirm_appointment(self, appointment_id):
        ...
        if appointment.state == 'cancelled':
            return """
                <html>
                    <body style="font-family:Arial; text-align:center; padding:50px;">
                        <h1 style="color:orange;">⚠️ Already Rejected!</h1>
                        <p>This appointment has already been rejected.</p>
                    </body>
                </html>
            """
    ...
    def reject_appointment(self, appointment_id):
        ...
        appointment.message_post(
            body=Markup("<p>Appointment status updated: <strong style='color:red;'>Rejected by Patient ❌</strong></p>"),
            message_type='comment',
            subtype_xmlid='mail.mt_comment',
        )
        return """
